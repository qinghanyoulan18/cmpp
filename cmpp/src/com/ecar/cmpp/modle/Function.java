...
import com.ecar.cmpp.util.Utils;

public class Function {
	
	protected static final Log log = LogFactory.getLog(Function.class);
	...
	public static long DatetoLong(String strDate) {
		try {
			...
			log.error("DatetoLong1日期转化格式异常"+e.getMessage(),e);
			return 0;
		}
	}
	...
	public static long DatetoLong(String strDate, String format) {
		try {
			...
			log.error("DatetoLong2日期转化格式异常"+e.getMessage(),e);
			return 0;
		}
	}
	...
	public static String LongtoDate(String longString, String format) {
		try {
			...
			log.error("LongtoDate日期转化格式异常"+e.getMessage(),e);
			return "";
		}
	}
